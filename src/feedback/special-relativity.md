...
最近在看[核融合未來展望](./future-of-fusion-energy/index.md)這本書時，慢慢接觸一些微觀中量子的物理行為和特性，在理解的過程中就會開始接觸到一些基於 _狹義相對論_（special relativity）建立的世界，也因此才開始本篇的撰寫。
...
相對而言，廣義相對論（general relativity）則是把這些概念延伸出來到其他場域，例如重力和電磁力。
