...
然而在反射望遠鏡的造價不菲，兩倍大的望遠鏡其成本會因為工程等等因素上升到約八倍左右（三次方成長）。
...
根據物理特性，焦距越短的望遠鏡、對這種效應的影響更嚴重。
以人的眼睛為例，大氣的干擾程度會讓人眼觀察天體的極限達到約 25 弧秒。
...
通常是使用太陽能，並搭配很大的太陽能板，你需要不同的工程技術和理論。
...
由於我們觀察到這個黑洞（和其周遭的物體）發射出的 *X射線* 的強度每秒會變動約一百次
...
我們再以以一個望遠鏡有多個 CCD 來考慮，所以一張天文照片約需要數 GB 來儲存。
...
透過 *都卜勒效應*，我們只要知道物體發出的頻率漸漸提高，就可以知道他它正在遠離，
