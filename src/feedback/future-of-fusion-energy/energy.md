...
我們不太可能透過生物能源來滿足人類所需的能量，除非未來可以在海上種植物（不考慮生態變異造成的影響），但是毫無疑問的，我們可以利用一些人類活動所產生的廢料（例如廚餘）來產生生物能量，並依此來避免能量的浪費。
...
[tidal-MoonEarth]: https://i.imgur.com/DlcyYpI.png
...
[germany-EnergyConsumption-yearly]: https://i.imgur.com/gKrOOjH.png
...
一般來說，上述提到的能源除了核能和石化燃料都屬於再生能源，或者說可以足量地補充的能源都屬於再生能源。但是我們也討論到了並不是每個再生能源都足夠我們使用，例如水力，就算我們接下來把全世界的水力發電廠都拿來持續發電五十億年，他所產生的能量都抵不過目前預估的所有石油能產生的能量。除此之外，並不是說再生能源就會對環境比較友善，例如太陽能發電板，即使未來 20 年讓它穩定發電，它所產生的二氧化碳仍是核能每單位能量所產生的二氧化碳的三倍；例如生物能源會需要砍伐地球的森林。

當我們在選擇使用的能源時，我們需要考慮的不僅是他是否屬於「再生能源」，在上述討論中我們也提到很多優劣勢，這些都是在選擇時可以放到檯面上讓大家去考慮的面向。
