...
Network Time Protocol（NTP），用來校時的古老協定
...
![NTP 運作原理](https://i.imgur.com/GGkQLNG.png)
...
!!! info 資料庫文案
    ...
    可無限擴充並具備一致性的雲端原生服務，可用性高達 99.999%。（$\dfrac{60*24*365}{100,000}=5.256$）
